...
import org.waletech.alms.repository.LiabilityReportRepository;
...
public class LiabilityReportServiceImpl implements LiabilityReportService {
     ...
     */
    @Override
    public LiabilityReport getLiabilityReportById(Long id) {
     ...
     */
    @Override
    public void deleteLiabilityReportById(Long id) {
